  ...
  return (
    <div className="contCrearProfile">
      <button onClick={() => navigation('/perfil/perfiles/cuentas')} className="btnExit">
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f3f3f3" fill="none" stroke-linecap="round" stroke-linejoin="round">
