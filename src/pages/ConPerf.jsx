...
function ConPerf() {
  ...
  return (
    <div className="contPerf">
      <Header tipo={'color'} user={user[0].nombre} back={true} />
      ...
      <div className="contBase">
        <Menu>
          ...
          <button onClick={() => cambioVis(2)}>Configuración</button>
          <button onClick={() => cambioVis(3)}>Historial de eventos </button>
        </Menu>
        <div className="navSideBar">
          <button onClick={() => cambioVis(1)}>Información general</button>
          <button onClick={() => cambioVis(2)}>Tipo de cuenta</button>
          <button onClick={() => cambioVis(3)}>Historial de eventos </button>
        </div>
        <div className="contVis">
          {
            cont === 1 ? (
              ...
              <section id="Configuracion">
                <div>
                  <h1>Darme de alta como negocio.</h1>
                </div>
                <div>
                  <h1>Darme de alta como patrocinador.</h1>
                </div>
                <div>
                  <h1>Darme de alta como artista.</h1>
                </div>
              </section>
            ) : cont === 3 ? (
