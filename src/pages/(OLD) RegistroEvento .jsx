        ...
        <div action="" className="registrarEventoForm">
          ...
          <div id="ContDetallesEvento" >
            <section className="horarios">
              <div>
                <p>Inicia el día</p>
                <input id="fechaInicio" name="fechaInicio" type="date" onChange={handleChange} value={datosEvento.fechaInicio} min={new Date().toISOString().split("T")[0]} required />
              </div>
              <div>
                <p>a las</p>
            ...
            <section className="horarios">
              <div>
                <p>Termina el día</p>
                <input id="fechaTermino" name="fechaTermino" type="date" onChange={handleChange} value={datosEvento.fechaTermino} min={datosEvento.fechaInicio} required />
              </div>
              <div>
                <p>a las</p>
                    ...
                    return (
                      <div key={index} className="tarjHome" onClick={() => AñSols(patrocinador.id, patrocinador.nombre, patrocinador.rol, patrocinador.perfil)}>
                        <div className="contImgTarj">
                          <div className="contContimg"><img src="" alt="Sin imagen" /></div>
                        </div>
                        ...
                        {solis.map((sol, index) => {
                          return (
                            <div className="tarjSol" key={index}>
                              ...
                              <button onClick={() => DelSols(sol.nombre)} title="Borrar de la lista"><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-trash-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f3f3f3" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7h16" /><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" /><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" /><path d="M10 12l4 4m0 -4l-4 4" /></svg></button>
                              <button title="Ir a su perfil"><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-eye" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f3f3f3" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="12" r="2" /><path d="M22 12c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7" /></svg></button>
                            </div>
                          )
                        })}
                      </fieldset>
