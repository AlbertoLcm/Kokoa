  ...
  return (
    <section className="homeChat">
      <section className="titulo">
        ...
        <Link to={`/negocio/${usuario.nombre}/${usuario.id}`} >
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-info-circle" width="35" height="35" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f3f3f3" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      <form method="POST" onSubmit={actionEviarMensaje} className="homeEscrituraChat">
        ...
        <button type="submit" className="send">
          <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-send" width="30" height="30" viewBox="0 0 24 24" stroke-width="1.5" stroke="#f3f3f3" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
