...
function RegistroEvento() {
    ...
    return (
        <div className="contBackground">
            <Header boton={'Crear Cuenta'} > <div className="regEvBotVolverPc"><button className="boton1" onClick={() => nav(-1)}>Volver</button></div> </Header>
            <div className="regEvContForm">
                ...
                <div className="regEvBotVolverChic"><button className="boton1" onClick={() => nav(-1)}>Volver</button></div>
            </div>
        </div>
    );
}
